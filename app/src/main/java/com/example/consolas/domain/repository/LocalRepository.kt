...
data class UserStats(val favoritesCount: Int, val averagePrice: Double)

interface LocalRepository {
    fun observeAllConsoles(): Flow<List<Console>>
    ...
    suspend fun upsertConsoles(consoles: List<Console>)
